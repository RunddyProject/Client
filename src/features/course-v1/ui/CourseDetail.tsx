...
import { useCourseDetail } from '@/features/course-v1/hooks/useCourseDetail';
import { buildElevationChartData } from '@/features/course-v1/lib/elevation';
import {
  GRADE_TO_NAME,
  SHAPE_TYPE_COLOR,
  SHAPE_TYPE_TO_NAME
} from '@/features/course-v1/model/constants';
import { ElevationChart } from '@/features/course-v1/ui/ElevationChart';
