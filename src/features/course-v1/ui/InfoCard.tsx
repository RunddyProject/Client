...
import { useSanitizedSvg } from '@/features/course-v1/hooks/useSanitizedSvg';
import { GRADE_TO_NAME } from '@/features/course-v1/model/constants';
...
import type { Course, GradeType } from '@/features/course-v1/model/types';
