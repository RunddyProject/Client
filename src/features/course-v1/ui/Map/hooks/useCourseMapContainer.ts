...
import { useCoursePoint } from '@/features/course-v1/hooks/useCoursePoint';
import { useCourses } from '@/features/course-v1/hooks/useCourses';
import { useOptimizedMarkers } from '@/features/course-v1/hooks/useOptimizedMarkers';
import {
  DEFAULT_ZOOM,
  SHAPE_TYPE_COLOR
...
import type {
  ...
  CourseMapHandlers
} from '@/features/course-v1/model/refactor-types';
