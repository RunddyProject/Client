    ...
    <DialogPortal data-slot='dialog-portal'>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          !fullWidth && 'max-w-[calc(100%-2rem)] sm:max-w-lg rounded-lg border p-6 shadow-lg',
          className
        )}
        {...props}
      >
...
function DialogHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'text-center sm:text-left grid grid-cols-[1fr_auto_1fr] items-center h-13 px-2 relative',
        className
      )}
      {...props}
    />
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn('text-lg leading-none font-semibold col-start-2 justify-self-center', className)}
      {...props}
    />
  );
}
